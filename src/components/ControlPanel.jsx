  ...
  return (
    <section className="z-30 w-full max-w-6xl my-10 flex flex-col gap-4 px-6">
      <div className="flex flex-wrap justify-center items-center gap-4">
        <div
          className="flex items-center gap-3 bg-white/[0.03] border border-white/5 rounded-full px-5 py-2.5 backdrop-blur-md shadow-inner"
          title="Tempo"
        >
          ...
          <input
            ...
            className="hidden sm:block w-20 md:w-24 accent-amber-400"
          />
          <div className="flex items-center bg-black/40 rounded-lg p-0.5 border border-white/5 focus-within:border-amber-500/50 transition-colors">
            <button
              ...
              className="w-6 h-6 flex items-center justify-center hover:bg-white/10 rounded-md text-amber-400/80 hover:text-amber-400 transition-colors text-lg leading-none"
            >
              -
            </button>
            <input
              ...
              className="w-10 bg-transparent text-center text-xs font-mono text-emerald-100 outline-none no-spinners"
            />
            <button
              type="button"
        ...
        <div className="flex items-center gap-2 bg-emerald-950/30 border border-emerald-500/20 rounded-full px-5 py-2.5 backdrop-blur-md">
          ...
          <span className="text-[10px] font-black text-emerald-200/70 uppercase tracking-widest mr-1 hidden sm:inline">
            Meter
          </span>
          <select
            value={timeSigNum}
            onChange={(event) => setTimeSigNum(Number(event.target.value))}
            className="bg-transparent outline-none text-sm text-emerald-400 font-black cursor-pointer appearance-none text-center"
          >
          ...
          <span className="text-[10px] font-black text-emerald-200/70 uppercase tracking-widest mr-1 md:mr-2">
            Grid
          </span>
          <select
            value={charResolution}
            onChange={(event) => setCharResolution(Number(event.target.value))}
            className="bg-transparent outline-none text-[11px] text-emerald-400 font-black cursor-pointer"
          >
        ...
        <div className="flex items-center gap-3 bg-white/[0.03] border border-white/5 rounded-full px-5 py-2.5 backdrop-blur-md">
          ...
          <input
            ...
            className="w-20 md:w-24 accent-emerald-400"
          />
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-center items-center gap-4">
        <button
          ...
          className={`px-6 py-2.5 rounded-full border transition-all text-[10px] font-black tracking-widest ${reverb ? 'bg-emerald-600/20 text-emerald-300 border-emerald-500/40 shadow-[0_0_15px_rgba(16,185,129,0.1)]' : 'bg-white/5 text-white/20 border-white/10'}`}
        >
          REVERB <span className="ml-1 opacity-30">{reverb ? 'ON' : 'OFF'}</span>
        </button>
        ...
        <div className="flex items-center gap-3 bg-white/[0.03] border border-white/5 rounded-full px-5 py-2.5 backdrop-blur-md">
          ...
          <select
            ...
            className="bg-transparent outline-none text-[11px] font-black text-emerald-100 uppercase"
          >
