export const NOTES_MAP = [
  { label: '高音區（上排）', sub: 'High', keys: [{ n: 'C5', k: 'q', f: 523.25 }, { n: 'D5', k: 'w', f: 587.33 }, { n: 'E5', k: 'e', f: 659.25 }, { n: 'F5', k: 'r', f: 698.46 }, { n: 'G5', k: 't', f: 783.99 }, { n: 'A5', k: 'y', f: 880.0 }, { n: 'B5', k: 'u', f: 987.77 }] },
  { label: '中音區（中排）', sub: 'Mid', keys: [{ n: 'C4', k: 'a', f: 261.63 }, { n: 'D4', k: 's', f: 293.66 }, { n: 'E4', k: 'd', f: 329.63 }, { n: 'F4', k: 'f', f: 349.23 }, { n: 'G4', k: 'g', f: 392.0 }, { n: 'A4', k: 'h', f: 440.0 }, { n: 'B4', k: 'j', f: 493.88 }] },
  { label: '低音區（下排）', sub: 'Low', keys: [{ n: 'C3', k: 'z', f: 130.81 }, { n: 'D3', k: 'x', f: 146.83 }, { n: 'E3', k: 'c', f: 164.81 }, { n: 'F3', k: 'v', f: 174.61 }, { n: 'G3', k: 'b', f: 196.0 }, { n: 'A3', k: 'n', f: 220.0 }, { n: 'B3', k: 'm', f: 246.94 }] },
];
...
export const DEFAULT_SCORE = `// 風物之詩琴預設示例
// 上排 QWERTYU 對應高音，中排 ASDFGHJ 對應中音，下排 ZXCVBNM 對應低音。
// 括號表示同時按下和弦，空白表示一個最小單位的停頓，豎線可作為小節分隔。
// 你也可以混用數字簡譜：1~7 = 中音，+1~+7 = 高音，-1~-7 = 低音。
